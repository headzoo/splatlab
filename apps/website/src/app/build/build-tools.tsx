...
const OBJECT_TOOLS: readonly ToolDefinition[] = [
  ...
  { value: "platform_spring", label: "Platform spring", description: "Launch the hero high while preserving their direction", icon: "↥" },
...
const TOOL_INSTRUCTIONS: Record<PlatformerEditTool, string> = {
  ...
  platform_spring: "Click the map to add a spring that launches the hero in their incoming direction.",
